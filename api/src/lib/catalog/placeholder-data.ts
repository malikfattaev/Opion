...
export const placeholderStyles: readonly ProductStyle[] = [
  { slug: "y2k", name: "Y2K" },
  { slug: "indie-sleaze", name: "Индислиз" },
  { slug: "loser-core", name: "Лузер-кор" },
...
export const placeholderProducts: readonly Product[] = [
  ...
  },
  {
    ...
    typeSlug: "jacket",
    styleSlugs: ["archive", "indie-sleaze"],
    price: 890000,
    sizes: ["S", "M", "L"],
    images: [],
  },
  ...
  },
  {
    ...
    typeSlug: "sweatshirt",
    styleSlugs: ["loser-core", "indie-sleaze"],
    price: 360000,
    sizes: ["S", "M", "L", "XL"],
    images: [],
  },
